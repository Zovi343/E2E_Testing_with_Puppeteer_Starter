...
const Home = () => (
    <div className="home">
        ...
        <h2 className="link_header">Link to the <a className="repo_link" href="https://github.com/Zovi343/E2E_Testing_with_Puppeteer_Starter" target="_blank">GitHub Repository</a></h2>
    </div>
);
